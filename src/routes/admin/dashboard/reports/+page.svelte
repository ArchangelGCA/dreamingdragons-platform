    ...
    <div class="accordion" id="reportsAccordion">
        <div class="accordion-item">
            <h2 class="accordion-header" id="openReportsHeading">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#openReports" aria-expanded="true" aria-controls="openReports">
                    <span>Open Reports <span class="{openReports.length === 0 ? 'text-success-emphasis' : 'text-danger-emphasis'}">{openReports.length}</span></span>
                </button>
            </h2>
            <div id="openReports" class="accordion-collapse collapse show" aria-labelledby="openReportsHeading" data-bs-parent="#reportsAccordion">
                <div class="accordion-body">
                    ...
                    {:else}
                        <h3 class="collapsible-title text-center link-book bg-danger bg-opacity-10 rounded-4 py-3" data-bs-toggle="collapse" data-bs-target="#openBookReports">Book Reports <i class="fas fa-chevron-down"></i></h3>
                        ...
                        <h3 class="collapsible-title text-center link-chapter bg-warning bg-opacity-10 rounded-4 py-3 mt-4" data-bs-toggle="collapse" data-bs-target="#openChapterReports">Chapter Reports <i class="fas fa-chevron-down"></i></h3>
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="closedReportsHeading">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#closedReports" aria-expanded="false" aria-controls="closedReports">
                    <span>Closed Reports <span class="text-primary-emphasis">{closedReports.length}</span></span>
                </button>
            </h2>
            <div id="closedReports" class="accordion-collapse collapse" aria-labelledby="closedReportsHeading" data-bs-parent="#reportsAccordion">
                <div class="accordion-body">
