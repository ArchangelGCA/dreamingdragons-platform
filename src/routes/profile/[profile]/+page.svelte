...
<Seo
        ...
        imageURL="{profile.avatar_url ? (image_proxy + profile.avatar_url) : 'https://tales.rosesintheflames.com/favicon.webp'}"
        logo="{profile.avatar_url ? (image_proxy + profile.avatar_url) : 'https://tales.rosesintheflames.com/favicon.webp'}"
        author="ArchangelGCA"
